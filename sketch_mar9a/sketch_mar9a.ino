// Uplaod the code in Arduino GIGA
//Before running code install ollama in your PC
//Open terminal in powershell paste the following commands
...
// Ollama API settings
const char* server = "your_PC_IP";  // Change this to your PC IPv4
const int port = 11434;
const char* endpoint = "/api/chat";

// Model configuration
const char* model = "llama3.2"; //Replace it with the model name you are using
